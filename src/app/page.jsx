...
export default function Home() {
  return (
    <div className="relative bg-black h-screen">
      ...
      {/* Hero Section */}
      <section id="home" className="relative z-10 flex flex-col justify-center h-full px-16 w-1/3">
        <p className="text-zinc-500 text-xs tracking-[0.3em] uppercase mb-6">
          From the Andes to the world
        </p>
        <h1 className="text-white text-7xl font-bold leading-none mb-6">
      ...
      <section id="contact" className="relative z-10 min-h-screen flex items-center px-32 py-32">
