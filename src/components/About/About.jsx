...
export default function About() {
    ...
    return (
        <section id="about" className="relative z-10 flex items-center px-32 py-32">
            ...
            <div className="w-1/2 pr-8">
                ...
                <p className="text-zinc-400 text-base leading-relaxed mb-4 max-w-md">
                    Originally from Peru where the Andes shaped my perspective <br/> I moved to Utah to pursue my Software Engineering degree at Ensign College.
                </p>
                <p className="text-zinc-400 text-base leading-relaxed mb-16 max-w-md">
                ...
                <div className="flex gap-16">
                    ...
                    <div>
                        <p className="text-white text-4xl font-bold">ISTQB</p>
            ...
            <div className="w-1/2 pl-16">
                ...
                {experiences.map((exp) => (
                    ...
                    >
                        ...
                        <p className="text-zinc-400 text-base">{exp.company}</p>
            ...
            {selected && (
                ...
                >
                    ...
                    >
                        ...
                        <h3 className="text-white text-3xl font-bold mb-1">{selected.role}</h3>
                        <p className="text-zinc-400 text-sm mb-1">
                            {selected.company} {selected.client && `· ${selected.client}`}
                        </p>
                        <p className="text-zinc-600 text-xs mb-8">{selected.location}</p>
